...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3">MCSCR - {{\App\Models\Area::find(Auth::user()->role_id)->name}}</h1>

    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('mcscr-area.create')}}" class="btn btn-pill btn-primary"><i class="far fa-plus"></i>Adicionar</a>
