<nav id="sidebar" class="sidebar" >
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('equipment-area.index')}}">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('area.index')}}">
                <i class="align-middle" data-feather="truck"></i> <span class="align-middle">Areas</span>
                </a>
            </li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="{{route('mcscr-area.index')}}">
