...
@endif
        <div class="col-md-12">
            <div class="card">
                ...
                @include('manutencao.meeting.modal.addparticipant')
                    ...
                    <table id="myTable" class="table display" >
                        ...
                        <tbody>
                            @foreach ($meeting->participants as $item)
                                ...
                                @include('manutencao.meeting.modal.editparticipant')
                                @include('manutencao.meeting.modal.deleteparticipant')
                                @include('manutencao.meeting.modal.sendmail')
                            @endforeach
                        </tbody>
                    </table>
                    </div>
                ...
                @include('manutencao.meeting.modal.addtask')
                    ...
                    <table id="myTable2" class="table display" >
                        ...
                        <tbody>
                            @foreach ($meeting->tasks as $item)
                                ...
                                @include('manutencao.meeting.modal.edittask')
                                @include('manutencao.meeting.modal.deletetask')
                            @endforeach
                        </tbody>
                    </table>
                    </div>
