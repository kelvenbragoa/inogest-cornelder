        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    {{-- <a href="{{route('area.create')}}" class="btn btn-pill btn-primary"><i class="far fa-plus"></i>Adicionar</a> --}}
                            ...
                            @foreach ($area as $item)
                                <tr>
                                    ...
                                    <td class="table-action">
                                        <a href="{{URL::to('/area/'.$item->id.'/edit')}}"><i class="align-middle" data-feather="edit-2"></i></a>
                                        <a href="{{URL::to('/area/'.$item->id)}}"><i class="align-middle" data-feather="eye"></i></a>
                                        {{-- <a href="" data-toggle="modal" data-target="#exampleModalCenter{{$item->id}}"><i class="align-middle" data-feather="trash"></i></a> --}}
                                    </td> 
                                </tr>
                                @include('manutencao.area.modaldelete')
                            @endforeach
                        </tbody>
                    </table>
                    </div>
