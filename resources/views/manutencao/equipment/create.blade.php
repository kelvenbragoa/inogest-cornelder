                    ...
                    <form method="POST" action="{{route('equipment.store')}}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <select type="text" class="form-control" name="area_id" id="area_id" placeholder="Área" required value="{{ old('area') }}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" name="omnicom_id" id="omnicom_id" placeholder="Omnicom Id"  value="{{ old('omnicom_id') }}">
                            </div>
