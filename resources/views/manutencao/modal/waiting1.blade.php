<div class="modal" id="waiting1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Equipamento Aguardando Peças</h5>
        ...
        <div class="modal-body">
          <div class="table-responsive">
            <table id="myTable1" class="table display" >
                ...
                <tbody>
                    @foreach (\App\Models\Mcscr::where('waiting_id',1)->get() as $item)
                        <tr>
