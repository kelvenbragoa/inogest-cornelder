    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="{{URL::to('/shiftdashboard-supervisor/'.$planning->id)}}"  class="btn btn-pill btn-primary"><i class="far fa-eye"></i>Painel do turno</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    @include('supervisor.planning_shift.brigade.modaladdbrigade')
                    <div class="table-responsive">
                                ...
                                @foreach ($brigade_planning as $item)
                                    <tr>
                                        ...
                                        <td class="table-action">
                                            <a href="{{URL::to('/planning-supervisor/'.$planning->id.'/brigade/'.$item->id)}}"><i class="align-middle" data-feather="eye"></i></a>
                                            {{-- <a href="" data-toggle="modal" data-target="#exampleModalCenter{{$item->id}}"><i class="align-middle" data-feather="trash"></i></a>  --}}
                                        </td> 
                                    </tr>
                                    @include('supervisor.planning_shift.brigade.modaldelete')
                                @endforeach
                            </tbody>
                        </table>
                        </div>
                        ...
                        @include('supervisor.planning_shift.equipment.modaladdequipment')
                    <div class="table-responsive">
                                ...
                                @foreach ($equipment_request as $item)
                                    <tr>
                                        ...
                                        <td class="table-action">
                                            ...
                                            <a href="{{URL::to('/planning-supervisor/'.$planning->id.'/equipmentrequest/'.$item->id)}}"><i class="align-middle" data-feather="eye"></i></a>
                                        </td> 
                                    </tr>
                                    @include('supervisor.planning_shift.equipment.modalviewequipment')
                                @endforeach
                            </tbody>
                        </table>
                        </div>
