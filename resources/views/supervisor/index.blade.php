            ...
            <div class="w-100">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-4">Total Turnos Supervionado</h5>
                                <div class="row">
                                    <div class="col">
                                        <h1 class="mt-1 mb-3">{{count(\App\Models\ScheduledShift::where('supervisor_1_id',Auth::user()->id)->orWhere('supervisor_2_id',Auth::user()->id)->get())}}</h1>
                                        <div class="mb-1">
                                          
                                        </div>
                                    </div>
                                    <div class="col">
                                        <h5 class="">Este mês: {{count(\App\Models\ScheduledShift::where('supervisor_1_id',Auth::user()->id)->orWhere('supervisor_2_id',Auth::user()->id)->whereMonth('created_at',date('m'))->whereYear('created_at',date('Y'))->get())}}</h5>
                                        <h5 class="">Este ano: {{count(\App\Models\ScheduledShift::where('supervisor_1_id',Auth::user()->id)->orWhere('supervisor_2_id',Auth::user()->id)->whereYear('created_at',date('Y'))->get())}}</h5>
