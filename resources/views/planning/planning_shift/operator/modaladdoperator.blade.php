        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select type="text" class="form-control" id="user_id" name="user_id" placeholder="Brigada" required>
                    @foreach (\App\Models\User::where('role_id',6)->where('terminal_id',Auth::user()->terminal_id)->orderBy('name','asc')->get() as $item)
          ...
          <input type="hidden" class="form-control" id="scheduled_shift_id" name="shift_id" value="{{$planning->id}}"> 
