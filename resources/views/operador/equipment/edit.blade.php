        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('mcscr-operador.update', $mcscr->id)}}" method="POST">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"  placeholder="Aberto"  value="{{ date('d-m-Y h:m:s', strtotime($mcscr->open_at)) }}" readonly> 
                            </div>
